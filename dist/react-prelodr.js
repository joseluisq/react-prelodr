...
var _seqr = __webpack_require__(30);

var _seqr2 = _interopRequireDefault(_seqr);

var _emitus = __webpack_require__(16);
...
var _quek = __webpack_require__(17);
...
var _prelodr = __webpack_require__(14);
...
var ReactPrelodr = function (_React$Component) {
  ...
  _createClass(ReactPrelodr, [{
    ...
    value: function addEventShown() {
      ...
      if (!_typeof(this.props.onShown) === 'function') return;
    ...
    value: function addEventHidden() {
      ...
      if (!_typeof(this.props.onHidden) === 'function') return;
